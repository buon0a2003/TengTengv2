...
class nhacungcapPolicy
{
    ...
    {
        return $user->can('view_any_nha::cung::cap');
    }
    ...
    {
        return $user->can('create_nha::cung::cap');
    }
    ...
    {
        return $user->can('delete_any_nha::cung::cap');
    }
    ...
    {
        return $user->can('force_delete_any_nha::cung::cap');
    }
    ...
    {
        return $user->can('restore_any_nha::cung::cap');
    }
    ...
    {
        return $user->can('reorder_nha::cung::cap');
    }
}
